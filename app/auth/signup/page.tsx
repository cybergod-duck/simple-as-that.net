...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0d0521] flex items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-purple-300/60 text-sm tracking-widest uppercase font-bold">Create Your Account</p>
                </div>
                ...
                <div className="bg-purple-950/40 backdrop-blur-xl border border-purple-500/20 rounded-3xl p-8 shadow-[0_0_40px_rgba(168,85,247,0.15)]">
                    ...
                    {sent ? (
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-purple-200/60">We sent a secure login link to <strong className="text-cyan-300">{email}</strong>. Click the link to finish creating your account.</p>
                        </div>
                    ) : (
                        <>
                            <h2 className="text-2xl font-bold text-white mb-2">Get Started</h2>
                            <p className="text-purple-200/60 text-sm mb-8">Create your free account to start building your website.</p>
                ...
                <p className="text-center mt-8 text-sm text-purple-300/40">
                    Already have an account? <Link href="/auth/login" className="text-cyan-400 hover:text-cyan-300 font-bold">Log In</Link>
                </p>
            </div>
        </div>
    );
